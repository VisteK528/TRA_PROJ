/**
  ...
  ******************************************************************************
  */
#ifndef AI_SPEECH_NETWORK_H
#define AI_SPEECH_NETWORK_H

#include "speech_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SPEECH_NETWORK_MODEL_NAME          "speech_network"
#define AI_SPEECH_NETWORK_ORIGIN_MODEL_NAME   "model_quantized2"

/******************************************************************************/
#define AI_SPEECH_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SPEECH_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SPEECH_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SPEECH_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_SPEECH_NETWORK_IN \
  ai_speech_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_NETWORK_IN_SIZE { \
  AI_SPEECH_NETWORK_IN_1_SIZE, \
}
#define AI_SPEECH_NETWORK_IN_SIZE_BYTES { \
  AI_SPEECH_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_SPEECH_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SPEECH_NETWORK_IN_1_HEIGHT      (129)
#define AI_SPEECH_NETWORK_IN_1_WIDTH       (126)
#define AI_SPEECH_NETWORK_IN_1_CHANNEL     (1)
#define AI_SPEECH_NETWORK_IN_1_SIZE        (16254)
#define AI_SPEECH_NETWORK_IN_1_SIZE_BYTES  (16254)

/******************************************************************************/
#define AI_SPEECH_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SPEECH_NETWORK_OUT \
  ai_speech_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SPEECH_NETWORK_OUT_SIZE { \
  AI_SPEECH_NETWORK_OUT_1_SIZE, \
}
#define AI_SPEECH_NETWORK_OUT_SIZE_BYTES { \
  AI_SPEECH_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_SPEECH_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SPEECH_NETWORK_OUT_1_CHANNEL     (8)
#define AI_SPEECH_NETWORK_OUT_1_SIZE        (8)
#define AI_SPEECH_NETWORK_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_SPEECH_NETWORK_N_NODES (16)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup speech_network
 ...
 * @ref ai_speech_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_speech_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_speech_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SPEECH_NETWORK_*
 * defines into file @ref speech_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_speech_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SPEECH_NETWORK_H */
