/**
  ...
  ******************************************************************************
  */
#ifndef AI_WORD_CLASSIFIER_H
#define AI_WORD_CLASSIFIER_H
...
#define AI_WORD_CLASSIFIER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_WORD_CLASSIFIER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_WORD_CLASSIFIER_IN_NUM        (1)

AI_DEPRECATED
#define AI_WORD_CLASSIFIER_IN \
  ai_word_classifier_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_WORD_CLASSIFIER_IN_SIZE { \
  AI_WORD_CLASSIFIER_IN_1_SIZE, \
}
#define AI_WORD_CLASSIFIER_IN_SIZE_BYTES { \
...
AI_DEPRECATED
#define AI_WORD_CLASSIFIER_OUT \
  ai_word_classifier_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_WORD_CLASSIFIER_OUT_SIZE { \
  AI_WORD_CLASSIFIER_OUT_1_SIZE, \
}
#define AI_WORD_CLASSIFIER_OUT_SIZE_BYTES { \
 ...
 * @ref ai_word_classifier_create. Both the activations memory buffer 
 ...
 * using @ref ai_word_classifier_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_word_classifier_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_word_classifier_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_WORD_CLASSIFIER_*
 * defines into file @ref word_classifier.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_word_classifier_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_WORD_CLASSIFIER_H */
