/**
  ...
  ******************************************************************************
  */
#ifndef AI_TRA_NETWORK_H
#define AI_TRA_NETWORK_H

#include "tra_network_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TRA_NETWORK_MODEL_NAME          "tra_network"
#define AI_TRA_NETWORK_ORIGIN_MODEL_NAME   "tra_test_82test_acc_pioterstft_float_float_int"

/******************************************************************************/
#define AI_TRA_NETWORK_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TRA_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TRA_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TRA_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_TRA_NETWORK_IN \
  ai_tra_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TRA_NETWORK_IN_SIZE { \
  AI_TRA_NETWORK_IN_1_SIZE, \
}
#define AI_TRA_NETWORK_IN_SIZE_BYTES { \
  AI_TRA_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_TRA_NETWORK_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TRA_NETWORK_IN_1_HEIGHT      (129)
#define AI_TRA_NETWORK_IN_1_WIDTH       (61)
#define AI_TRA_NETWORK_IN_1_CHANNEL     (1)
#define AI_TRA_NETWORK_IN_1_SIZE        (7869)
#define AI_TRA_NETWORK_IN_1_SIZE_BYTES  (31476)

/******************************************************************************/
#define AI_TRA_NETWORK_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TRA_NETWORK_OUT \
  ai_tra_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TRA_NETWORK_OUT_SIZE { \
  AI_TRA_NETWORK_OUT_1_SIZE, \
}
#define AI_TRA_NETWORK_OUT_SIZE_BYTES { \
  AI_TRA_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_TRA_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TRA_NETWORK_OUT_1_CHANNEL     (8)
#define AI_TRA_NETWORK_OUT_1_SIZE        (8)
#define AI_TRA_NETWORK_OUT_1_SIZE_BYTES  (32)

/******************************************************************************/
#define AI_TRA_NETWORK_N_NODES (15)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tra_network
 ...
 * @ref ai_tra_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_tra_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tra_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tra_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TRA_NETWORK_*
 * defines into file @ref tra_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tra_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TRA_NETWORK_H */
